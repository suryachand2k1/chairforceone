...
//
// Code generated for Simulink model 'chairforceone'.
//
// Model version                  : 1.9
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Tue Oct 29 21:18:28 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"chairforceone\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(chairforceone_M, (NULL));
        chairforceone_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(chairforceone_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(chairforceone_M)
                == (NULL)) || rtmGetStopRequested(chairforceone_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(chairforceone_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
