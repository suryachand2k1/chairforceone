...
struct P_chairforceone_T_ {
  ...
  SL_Bus_chairforceone_std_msgs_Float64 Constant_Value_p;/* Computed Parameter: Constant_Value_p
                                                          ...
                                                          */
  real_T Observed_Lead_Vehicle_Max_Decel;/* Expression: 3
                                          ...
                                          */
  real_T Ego_Max_Deceleration_Value;   /* Expression: 3.5
                                        * Referenced by: '<Root>/Ego_Max_Deceleration'
                                        */
  real_T Min_Breaking_point_Gap_Value; /* Expression: 10
                                        * Referenced by: '<Root>/Min_Breaking_point_Gap'
                                        */
  real_T Min_Space_Gap_At_All_Times_Valu;/* Expression: 5
  ...
  real_T Speed_limit_Value;            /* Expression: 70
                                        ...
                                        */
  real_T Operational_FrequencyHz_Value;/* Expression: 20
                                        * Referenced by: '<S2>/Operational_Frequency(Hz)'
                                        */
  real_T Error_for_Max_AccelTheerrordist;/* Expression: 500
